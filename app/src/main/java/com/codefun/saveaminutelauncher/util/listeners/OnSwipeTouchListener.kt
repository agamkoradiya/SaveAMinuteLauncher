package com.codefun.saveaminutelauncher.util.listeners
...
import com.codefun.saveaminutelauncher.util.LONG_PRESS_DELAY_MS
import com.codefun.saveaminutelauncher.util.TRIPLE_TAP_DELAY_MS
import java.util.*
...
internal open class OnSwipeTouchListener(c: Context?) : OnTouchListener {
    ...
    private inner class GestureListener : SimpleOnGestureListener() {
        ...
        override fun onDoubleTap(e: MotionEvent): Boolean {
            doubleTapOn = true
            Timer().schedule(TRIPLE_TAP_DELAY_MS.toLong()) {
                if (doubleTapOn) {
                    doubleTapOn = false
                    onDoubleClick()
                }
        ...
        override fun onLongPress(e: MotionEvent) {
            longPressOn = true
            Timer().schedule(LONG_PRESS_DELAY_MS.toLong()) {
